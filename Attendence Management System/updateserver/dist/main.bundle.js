...
var attendence_component_1 = __webpack_require__("../../../../../src/app/attendence/attendence.component.ts");
var entry_component_1 = __webpack_require__("../../../../../src/app/entry/entry.component.ts");
...
/***/ "../../../../../src/app/attendence/attendence.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/attendence/attendence.component.html":
/***/ (function(module, exports) {

module.exports = "\n <a routerLink='/home' >   \n    <input type=\"button\" name=\"return\" value=\"BACK TO HOME PAGE\">\n    </a>\n\n<hr>\n<h1 align=\"center\" >DAILY ATTENDENCE LIST</h1>\n<hr>\n<div align=\"center\">\n    <form [formGroup]=\"aform\" (ngSubmit)=onSubmit(aform.value)>\n      <tr>\n        <td> Select date: </td>\n        <td>\n          <input type=\"date\" name=\"date\" placeholder=\"Choose Date\" formControlName=\"date\">\n        </td>\n      </tr>\n      <tr>\n        <td> Select class: </td>\n        <td>\n          <select name=\"class\" formControlName=\"class\">\n            <option value=\"1\">1st class</option>\n            <option value=\"2\">2nd class</option>\n            <option value=\"3\">3rd class</option>\n            <option value=\"4\">4th class</option>\n            <option value=\"5\">5th class</option>\n            <option value=\"6\">6th class</option>\n            <option value=\"7\">7th class</option>\n            <option value=\"8\">8th class</option>\n            <option value=\"9\">9th class</option>\n            <option value=\"10\">10th class</option>\n            <option value=\"11\">11th class</option>\n            <option value=\"12\">12th class</option>\n          </select>        \n        </td>\n      </tr>\n      <tr colspan=\"2\">\n        <td style=\"padding: 10px 0 10px 104px;\">\n            <input type=\"submit\" value=\"submit\">\n        </td>\n      </tr>\n    </form>\n    \n</div>\n<table align=\"center\" border=\"1px\">\n  <thead>\n  <tr style=\"font-weight:bold;\" >\n    <td> NAME  </td>\n    <td> AGE </td>\n    <td> ADDRESS </td>\n    <td> CLASS </td>\n    <td> STATUS </td>\n    <td> DATE </td>\n  </tr>\n</thead>\n<tbody>\n  \n  <tr *ngFor=\"let device of list\">\n      <td>{{ device.name }}</td>\n      <td>{{ device.age }}</td>\n      <td>{{ device.address }}</td>\n      <td>{{ device.class }}</td> \n      <td>{{ device.status }}</td>     \n      <td>{{ device.date}}</td>\n    </tr>\n</tbody>\n</table>"
...
var AttendenceComponent = /** @class */ (function () {
    function AttendenceComponent(http, authService) {
        this.http = http;
        this.authService = authService;
    }
    AttendenceComponent.prototype.ngOnInit = function () {
        this.aform = new forms_1.FormGroup({
            date: new forms_1.FormControl("", forms_1.Validators.required),
            class: new forms_1.FormControl("", forms_1.Validators.required)
        });
    };
    AttendenceComponent.prototype.onSubmit = function (user) {
        var _this = this;
        console.log("values are: ", this.aform.value);
        this.authService.attendence(user).subscribe(function (data) {
            console.log(data);
            if (data.status) {
    ...
    AttendenceComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("../../../../../src/app/attendence/attendence.component.html"),
            styles: [__webpack_require__("../../../../../src/app/attendence/attendence.component.css")]
        }),
...
var AuthService = /** @class */ (function () {
  ...
  */
    ...
    AuthService.prototype.attendence = function (user) {
        var headers = new http_1.Headers();
        headers.append('content-type', 'application/json');
        headers.append('charset', 'UTF-8');
        return this.http.post("/api/attendence", user, { headers: headers }).map(function (res) { return res.json(); });
    };
...
module.exports = "<a routerLink='/home' >   \n  <input type=\"button\" name=\"return\" value=\"BACK TO HOME PAGE\">\n  </a>\n  <h1 align=\"center\"> STUDENT ATTENDENCE</h1>\n\n<table align=\"center\">\n  <form [formGroup]=\"eform\" (ngSubmit)=onSubmit(eform.value)>\n    <tr>\n      <td>\n        <input type=\"text\" name=\"name\" placeholder=\"Name of the Student\" formControlName=\"name\">\n      </td>\n    </tr>\n    <tr>\n        <td>\n          <input type=\"text\" name=\"age\" placeholder=\"Age of the Student\" formControlName=\"age\">\n        </td>\n      </tr>\n      <tr>\n          <td>\n            <input type=\"text\" name=\"address\" placeholder=\"Address of the Student\" formControlName=\"address\">\n          </td>\n        </tr>\n        <tr>\n            <td>\n              <select name=\"class\" formControlName=\"class\">\n                <option value=\"1\">1st class</option>\n                <option value=\"2\">2nd class</option>\n                <option value=\"3\">3rd class</option>\n                <option value=\"4\">4th class</option>\n                <option value=\"5\">5th class</option>\n                <option value=\"6\">6th class</option>\n                <option value=\"7\">7th class</option>\n                <option value=\"8\">8th class</option>\n                <option value=\"9\">9th class</option>\n                <option value=\"10\">10th class</option>\n                <option value=\"11\">11th class</option>\n                <option value=\"12\">12th class</option>\n              </select>\n            </td>\n          </tr>\n          <tr>\n            <td>\n              <select name=\"status\" formControlName=\"status\">\n                  <option value=\"Present\">Present</option>\n                  <option value=\"Absent\">Absent</option>\n              </select>\n            </td>\n          </tr>\n          <tr>\n              <td>\n                <input type=\"date\" name=\"date\" placeholder=\"Choose Date\" formControlName=\"date\">\n              </td>\n            </tr>\n            <tr colspan=\"2\" align=\"center\">\n                <td>\n                  <input type=\"submit\" value=\"submit\" name=\"submit\" [disabled]=\"!eform.valid\">\n                </td>\n            </tr>\n  </form>\n</table>"
...
var EntryComponent = /** @class */ (function () {
    function EntryComponent(authService, router) {
        this.authService = authService;
        this.router = router;
    }
    EntryComponent.prototype.ngOnInit = function () {
        this.eform = new forms_1.FormGroup({
    ...
    EntryComponent.prototype.onSubmit = function (user) {
        var _this = this;
        console.log("values are: ", this.eform.value);
        this.authService.entry(user).subscribe(function (data) {
            console.log(data);
            if (data.status) {
